    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-md-4">
                ...
                <a href="admin/create-siswa" class="btn btn-primary btn-sm mt-3 mb-5">+ Tambah Siswa</a>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="admin/store-siswa" method="post" id="form-store">
                            @csrf
                            <div class="mb-3">
